...
# Load Model
model_folder = '../../data/savedVAE/'
data_folder = '/Myawesomerootlocation/ATIAM/4_Informatique/MachineLearning_Project/Datasets/'
...
data_name = 'toy_harmonic_richness.npz'
Z_dim = 20
...
toydataset_1 = NPZ_Dataset(npz_file=data_name, root_dir= data_folder , dataName='Spectrums')
